    ...
    const get_wash_summary = () => {
        ...
        $.ajax({
            ...
            error: function(response, jqXHR, textStatus, errorThrown) {
                response.status !== 404 ? generateApiError(response, true) : templateAlertContainer(holder, 'no-data', "No wash found for this context to generate the summary", 'add a wash', '<i class="fa-solid fa-soap"></i>','/trip/add')
            }
        })
    }
    get_wash_summary()
