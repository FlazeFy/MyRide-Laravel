        ...
        const fetchData = () => {
            $.ajax({
                ...
                error: function(response, jqXHR, textStatus, errorThrown) {
                    Swal.close()
                    response.status !== 404 ? generateApiError(response, true) : templateAlertContainer(ctx_holder, 'no-data', "No wash found for this context to generate the stats", 'add a wash', '<i class="fa-solid fa-soap"></i>','/wash/add')
                }
            })
        }
