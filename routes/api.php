...
Route::prefix('/v1/stats')->middleware(['auth:sanctum'])->group(function () {
    ...
    Route::get('/journey/{vehicle_id}', [QueriesStatsApi::class, 'getJourney']);
    Route::get('/partner', [QueriesStatsApi::class, 'getPartner']);
    Route::get('/place', [QueriesStatsApi::class, 'getPlace']);
...
Route::prefix('/v1/fuel')->middleware(['auth:sanctum'])->group(function () {
    ...
    Route::get('/vehicle', [QueriesFuelController::class, 'getAllVehicleFuel']);
