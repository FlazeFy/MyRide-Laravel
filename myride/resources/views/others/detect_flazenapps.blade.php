...
<script>
    ...
    if (opened_from === 'flazenapps') {
        ...
        $('#alert-flazenapps').html(`
            <a class="btn btn-warning text-dark" data-bs-toggle="collapse" href="#multiCollapseExample1" role="button" aria-expanded="false" aria-controls="multiCollapseExample1">FlazenApps Was Here!</a>
            <div class="collapse multi-collapse mt-3" id="multiCollapseExample1">
                <div class="content">
                    <h2 class="mb-2 text-dark">Hey FlazenApps Was Here!</h2>
                    <p class="text-dark mb-2">We know that you have opened <b>MyRide</b> from <b>FlazenApps</b> platform, are you want to use our testing account so you can explore this apps easily?</p>
                    ...
                    <a class="btn btn-link" href="mailto:flazen.edu@gmail.com?subject=Hello%20FlazenApps&body=I%20want%20to%20know%20more%20about%20MyRide"><i class="fa-solid fa-envelope me-1"></i> flazen.edu@gmail.com</a>
                </div>
            </div>
        `)
    } else {
