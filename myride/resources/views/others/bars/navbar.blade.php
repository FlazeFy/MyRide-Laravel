    ...
    <div class="d-inline-block w-100 d-flex flex-wrap gap-3 align-items-center">
        ...
        <div>
            ...
            <div class="navbar-collapse-mobile flex-wrap gap-2">
                <a class="btn btn-primary px-3" id="profile-button-collapse" href="<?= Route::current()->uri() === "/" ? "/dashboard" : "/profile"?>"><i class="fa-solid fa-user"></i><span class="button-text"> {{session()->get('username_key')}}</span></a>
