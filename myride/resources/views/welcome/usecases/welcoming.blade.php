<div style="margin: 10vh 0; max-width: 960px;" class="d-block mx-auto">
    <img src="{{asset('assets/logo_nocap.png')}}" style='width:40vh;'>
    <h1 class="fw-bold" style="font-size:60px;">One App, Total Vehicle Care</h1>
    <hr>
