<div style="margin: 10vh 0; max-width: 1080px;" class="d-block mx-auto" id="services_section">
    <div class="bg-primary text-white rounded-pill px-3 py-2 d-block mx-auto" style="width:140px;">FAQ's</div>
    <br>
                    ...
                    $('#faq_holder').append(`
                        <div class="col-lg-6 col-md-6 col-sm-12 col-12 mx-auto">
                            <div class="container-service">
                                ...
                                <div class="collapse p-3 text-white mt-3" id="collapseFAQ_${idx}" data-bs-parent="#faq_holder">${dt.faq_answer}</div>
                            </div>
                        </div>
                    `)
                });
