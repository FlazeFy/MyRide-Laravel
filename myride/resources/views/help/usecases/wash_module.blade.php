...
<ol>
    <li>Open your sidebar and press button <b class="text-success">Wash</b>, after that you will be redirect to Wash Page.</li>
    <li>Your wash history is displayed in a table format.</li>
</ol>
<h3>How to Edit Your Wash History?</h3>
<ol>
    <li>Open your sidebar and press button <b class="text-success">Wash</b>, after that you will be redirect to Wash Page.</li>
    <li>Your wash history is displayed in a table format.</li>
    <li>To see the wash edit form, you can press the button that have "<b class="text-success">Edit</b>" icon. An edit pop-up will appear.</li>
...
<h3>How to Delete Your Wash History?</h3>
<ol>
    <li>Open your sidebar and press button <b class="text-success">Wash</b>, after that you will be redirect to Wash Page.</li>
    <li>Your wash history is displayed in a table format.</li>
    <li>After you find the wash history that you want to delete. Press the button that have "<b class="text-success">Trash</b>" icon.</li>
    <li>A validation pop-up will appear, press <b class="text-success">Yes, delete it</b> button to finally delete your wash history.</li>
</ol>