        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                data.forEach(dt => {
                    ...
                    : 
                        generateMonthlySummary(dt.month, dt.total_trip, dt.total_service, dt.total_wash, dt.total_fuel, dt.person_most_trip_with, dt.monthly_most_trip_category, targetElement)
                })
            },
