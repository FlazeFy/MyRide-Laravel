...
<div class="container bordered">
    ...
    <h6>Plate Number : <span class="text-secondary ms-2" id="vehicle_plate_number"></span></h6>
    ...
    const get_vehicle_by_id = (page,id) => {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $('#vehicle_plate_number').html(detail.vehicle_plate_number)
                ...
                $('#vehicle_status').html(`<span class="btn btn-success rounded-pill px-3 me-2" style="font-size:var(--textMD);">${detail.vehicle_status}</span>`)
