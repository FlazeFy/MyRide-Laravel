...
<div class="row">
    <div class="col-lg-4 col-md-6 col-sm-6 col-6 mx-auto">
        ...
        <h4 class="fw-bold text-capitalize" id="most_person_with"></h4>
    </div>
    <div class="col-lg-4 col-md-6 col-sm-6 col-6 mx-auto">
        <h5>Total Distance</h5>
        <h4 class="fw-bold text-capitalize" id="vehicle_total_trip_distance"></h4>
    </div>
    <div class="col-lg-4 col-md-6 col-sm-6 col-6 mx-auto">
        <h5>Most Origin</h5>
        <h4 class="fw-bold text-capitalize" id="most_origin"></h4>
    </div>
    <div class="col-lg-4 col-md-6 col-sm-6 col-6 mx-auto">
        <h5>Most Destination</h5>
        <h4 class="fw-bold text-capitalize" id="most_destination"></h4>
    </div>
    <div class="col-lg-4 col-md-6 col-sm-6 col-6 mx-auto">
        <h5>Most Category</h5>
        <h4 class="fw-bold text-capitalize" id="most_category"></h4>
    </div>
</div>
