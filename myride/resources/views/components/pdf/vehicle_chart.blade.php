...
<body>
    <div style='text-align:center;'>
        ...
        <h4 style='color:#212121; margin:0; font-style:italic;'>One App, Total Vehicle Care</h4><br>
    </div>
    <hr>

    <h3 style='margin:0 0 6px 0;'>Username : {{$username}}</h3>
    <p style='font-size:13px; text-align: justify;'>
        At {{$date}}, the system just run weekly audit for your vehicle. Here you can see the stats in this document :
    </p>  
