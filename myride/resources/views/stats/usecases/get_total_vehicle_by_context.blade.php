            ...
            $.ajax({
                ...
                error: function(response, jqXHR, textStatus, errorThrown) {
                    ...
                    if(response.status != 404){
                        ...
                        template_alert_container(ctx_holder, 'no-data', "No vehicle found for this context to generate the stats", 'add a inventory', '<i class="fa-solid fa-warehouse"></i>','/inventory/add')
