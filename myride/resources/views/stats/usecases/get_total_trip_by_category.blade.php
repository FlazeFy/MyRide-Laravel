            ...
            $.ajax({
                ...
                error: function(response, jqXHR, textStatus, errorThrown) {
                    ...
                    if(response.status != 404){
                        ...
                        templateAlertContainer(ctx_holder, 'no-data', "No trip found for this context to generate the stats", 'add a inventory', '<i class="fa-solid fa-warehouse"></i>','/inventory/add')
