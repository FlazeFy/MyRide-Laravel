...
class Queries extends Controller
{
    ...
    /**
     * @OA\GET(
     *     path="/api/v1/trip/coordinate",
     *     summary="Get Trip All Coordinate",
     *     description="This request is used to get all trip coordinate, using in maps only. This request interacts with the MySQL database, and has a protected routes.",
     *     tags={"Trip"},
     *     security={{"bearerAuth":{}}},
     *     @OA\Response(
     *         response=200,
