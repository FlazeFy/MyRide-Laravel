...
class Queries extends Controller
{
    ...
    /**
     * @OA\GET(
     *     path="/api/v1/stats/place",
     *     summary="Get All Place Stats",
     *     description="This request is used to get all trip place stats. This request is using MySql database, and has a protected routes",
     *     tags={"Stats"},
     *     security={{"bearerAuth":{}}},
     *     @OA\Response(
     *         response=200, description="stats fetched",
     ...
     *                      @OA\Property(
     *                          property="partner", type="array",
     *                          @OA\Items(
     *                              type="object",
     *                              @OA\Property(property="context", type="string", example="Jhon Doe"),
     *                              @OA\Property(property="total", type="integer", example=2)
     *                          )
     *                      ),
     *                 )
